...
export default {
    ...
    convert(options = {}) {
        ...
        options.pointMaterial = ReferLayerProperties(new THREE.PointsMaterial(), options.layer);
        options.lineMaterial = ReferLayerProperties(new THREE.LineBasicMaterial(), options.layer);
        options.polygonMaterial = ReferLayerProperties(new THREE.MeshBasicMaterial(), options.layer);
