...
export default {
    executeCommand(command) {
        ...
        return node.load().then((geometry) => {
            ...
            // // const newOrigin = new THREE.Vector3(...positions.array.subarray(0, 3))
            // //     .add(origin)
            ...
            for (let i = 0; i < positions.count; i++) {
                ...
                positions.array[i * 3] = coord.x;// - newOrigin.x;
                positions.array[i * 3 + 1] = coord.y;// - newOrigin.y;
                positions.array[i * 3 + 2] = coord.z;// - newOrigin.z;
            }
