...
/**
 * A `RasterNode` is part of raster [`Layer`]{@link Layer} data.
 * This part is a spatial subdivision of the extent of a layer.
 * In the `RasterNode`, The data are converted on three.js textures.
 * This `RasterNode` textures are assigned to a `LayeredMaterial`.
