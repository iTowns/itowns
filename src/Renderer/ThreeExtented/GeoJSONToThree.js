...
GeoJSONToThree.prototype.convert = function(geoJson) {
    var geometries = [];
    var propertiesList = [];
    var geometrySize = [];
    var totalSize = 0;
...
GeoJSONToThree.prototype.setUpBarycentricCoordinates = function(geometry) {
...
GeoJSONToThree.prototype.geomToThree = function(geom) {
...
GeoJSONToThree.prototype.geomFromGeoJSON = function(type, coords) {
...
GeoJSONToThree.prototype.geomFromPolyhedralSurface = function(coords) {
    var t, v, i, j;
    var U, V, N;
    var nPoints = 0;
