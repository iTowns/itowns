 ...
 */
PlanarCameraControls.prototype.rotate = function(deltaX, deltaY) {
 ...
 */
PlanarCameraControls.prototype.panLeft = function(distance, matrix) {
 ...
 * @param matrix : the matrix of the camera.
 */
PlanarCameraControls.prototype.panForward = function(distance, matrix) {
 ...
 */
PlanarCameraControls.prototype.panUp = function(deltaY) {
 ...
 * @param deltaY : the offset value of the mouse movement along the Y axis.
 */
PlanarCameraControls.prototype.pan = function(deltaX, deltaY) {
 ...
 * @param deltaY : the offset value of the mouse movement along the Y axis.
 */
PlanarCameraControls.prototype.update = function() {
 ...
 */
PlanarCameraControls.prototype.handleKeyDown = function(event) {
 ...
 */
PlanarCameraControls.prototype.handleMouseDownRotate = function(event) {
 ...
 */
PlanarCameraControls.prototype.handleMouseDownPan = function(event) {
 ...
 * @param event : the mouse down event.
 */
PlanarCameraControls.prototype.handleMouseDownDolly = function(event) {
 ...
 */
PlanarCameraControls.prototype.handleMouseWheel = function(event) {
 ...
 */
PlanarCameraControls.prototype.handleMouseMoveRotate = function(event) {
 ...
 */
PlanarCameraControls.prototype.handleMouseMovePan = function(event) {
...
PlanarCameraControls.prototype.handlePick = function(event) {
 ...
 * @param event: the current event
 */
PlanarCameraControls.prototype.onKeyDown = function(event) {
 ...
 * @param event: the current event
 */
PlanarCameraControls.prototype.onKeyUp = function(event) {
 ...
 */
PlanarCameraControls.prototype.onMouseDown = function(event) {
 ...
 * @param event: the current event
 */
PlanarCameraControls.prototype.onMouseUp = function(event) {
 ...
 * @param event: the current event
 */
PlanarCameraControls.prototype.onMouseWheel = function(event) {
 ...
 * @param event: the current event
 */
PlanarCameraControls.prototype.onMouseMove = function(event) {
