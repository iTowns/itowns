...
Scene.prototype.quadTreeRequest = function(quadtree, process) {
    ...
    if(this.layers[1]) this.browserScene.browse(this.layers[1].node,this.currentCamera(), this.layers[1].process, this.map.layersConfiguration, SUBDIVISE);  // TODO: tmp
    this.managerCommand.runAllCommands().then(function() {
        if (this.managerCommand.isFree()) {
            ...
            if (this.managerCommand.isFree()) {
                ...
                if(this.layers[1]) this.browserScene.browse(this.layers[1].node, this.currentCamera(), this.layers[1].process, this.map.layersConfiguration, CLEAN)  //TODO: temp
...
Scene.prototype.realtimeSceneProcess = function() {
    ...
    if(this.layers[1]) this.browserScene.browse(this.layers[1].node,this.currentCamera(), this.layers[1].process, this.map.layersConfiguration, NO_SUBDIVISE);  // TODO: tmp
};
