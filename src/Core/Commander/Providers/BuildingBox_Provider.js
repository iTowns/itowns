...
define('Core/Commander/Providers/BuildingBox_Provider',[
 ...
 //**************** ROOF ****************************
    ...
    BuildingBox_Provider.prototype.addRoad = function(geometry, bbox, altitude_road, ellipsoid){
         ...
         var pos = new THREE.Vector3((bbox.minCarto.longitude + bbox.maxCarto.longitude)/2,
                                      altitude_road,
                                     (bbox.minCarto.latitude + bbox.maxCarto.latitude)/2);//48.8505774,  altitude_sol, 2.3348124);
