...
//ATTENTION: duplicate this function of POCLoader to avoid the complexity of double direction
//of requirejs
utils.createChildAABB = function(aabb, childIndex){
 ...
 */
utils.computeTransformedBoundingBox = function (box, transform) {
...
utils.createGrid = function createGrid(width, length, spacing, color){
...
utils.createBackgroundTexture = function(width, height){
...
utils.leftView = function(camera, controls, pointcloud){
...
utils.rightView = function(camera, controls, pointcloud){
	camera.position.set(1, 0, 0);
	camera.rotation.set(0, Math.PI / 2, 0);
	camera.zoomTo(pointcloud, 1);
 ...
 * 2: fully inside
 */
utils.frustumSphereIntersection = function(frustum, sphere){
