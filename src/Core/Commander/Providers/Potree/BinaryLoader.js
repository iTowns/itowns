define(['THREE','./Version', './workers', './PointAttributeNames'], function(THREE, Version, workers, PointAttributeNames){

var BinaryLoader = function(version, boundingBox, scale){
...
BinaryLoader.prototype.parse = function(node, buffer){
	...
	var ww = workers.binaryDecoder.getWorker();
	ww.onmessage = function(e){
		...
		workers.binaryDecoder.returnWorker(ww);
