...
var PointCloudOctreeGeometryNode = function(name, pcoGeometry, boundingBox){
	this.id = IDCount++;
	this.name = name;
...
PointCloudOctreeGeometryNode.prototype.load = function(){
	...
	//if(PointCloudOctree.lru.numPoints + this.numPoints >= pointLoadLimit){
	//	PointCloudOctree.disposeLeastRecentlyUsed(this.numPoints);
	//}
...
return PointCloudOctreeGeometryNode;
