...
define('Core/Commander/Providers/FeatureProvider', [
...
], function(WFS_Provider, proj4, BoundingBox, THREE, BuilderEllipsoidTile, Projection, Ellipsoid, CoordCarto) {
	...
	function FeatureProvider(params) {
		...
		this.offsetValue 	= (obj !== undefined && obj.length 		!== undefined) ? obj.length 	 : 40;
