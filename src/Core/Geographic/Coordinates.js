...
class Coordinates {
     ...
     *
     * @param  {array}  array array to store this vector to. If this is not provided a new array will be created.
     * @param  {number}  [offset=0]  optional offset into the array.
     *
     * @return {array} Returns an array [x, y, z], or copies x, y and z into the provided array.
     */
