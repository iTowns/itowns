...
class Extent {
    ...
    /**
     * Returns a new extent with the same values as this one.
     */
    clone() {
     ...
     * @param crs - the projection of destination.
     * @param target - copy the destination to target.
     */
     ...
     * @param target - copy the center to the target.
     */
     ...
     */
    isInside(extent: Extent, epsilon = CRS.reasonnableEpsilon(this.crs)) {
