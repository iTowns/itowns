   ...
   var Delaunay = {
    ...
    CVML.Ransac = function (fittingProblem, points, threshold) {
        ...
        CVML.clone = function(A,k,n) {
            if(typeof k === "undefined") { k=0; }
            if(typeof n === "undefined") { n = CVML.sdim(A).length; }
        ...
        CVML.dot = function dot(x,y) {
            ...
            switch(d(x).length*1000+d(y).length) {
                    ...
                    case 2001: return CVML.dotMV(x,y);
                    case 1002: return CVML.dotVM(x,y);
                    case 1001: return CVML.dotVV(x,y);
                    case 1000: return CVML.mulVS(x,y);
                    case 1: return CVML.mulSV(x,y);
                    case 0: return x*y;
                    default: throw new Error('dot only works on vectors and matrices');
            }
        };
