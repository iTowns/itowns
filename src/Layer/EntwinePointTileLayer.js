...
class EntwinePointTileLayer extends PointCloudLayer {
    ...
    constructor(id, config) {
        ...
        this.whenReady = this.source.whenReady.then(() => {
            ...
            this.minElevationRange = config.minElevationRange ?? this.source.boundsConforming[2];
            this.maxElevationRange = config.maxElevationRange ?? this.source.boundsConforming[5];
