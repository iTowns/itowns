...
class Layer extends THREE.EventDispatcher {
     ...
     * @param {number} [config.sizeTextureTile=256] - set the texture size and, if applied to the globe, affects the tile subdivision.
     *
     * @example
    ...
    constructor(id, config = {}) {
        ...
        this.sizeDiagonalTexture =  (2 * (this.sizeTextureTile * this.sizeTextureTile)) ** 0.5;
