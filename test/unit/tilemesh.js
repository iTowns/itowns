...
describe('TileMesh', function () {
    ...
    it('event updatedElevation RasterElevationNode sets TileMesh bounding box ', () => {
    ...
    it('RasterElevationNode throws error if ElevationLayer.useRgbaTextureElevation is true', () => {
    ...
    it('RasterElevationNode is set if ElevationLayer.useColorTextureElevation is true', () => {
    ...
    it('RasterElevationNode min and max are set by xbil texture', () => {
