...
describe('Extent', function () {
    ...
    it('should clone tiled extent like expected', function () {
        ...
        const clonedTile = withValues.clone();
        assert.equal(clonedTile.zoom, withValues.zoom);
        assert.equal(clonedTile.row, withValues.row);
        assert.equal(clonedTile.col, withValues.col);
    });
