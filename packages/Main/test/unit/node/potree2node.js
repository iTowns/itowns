        ...
        describe('loadHierarchy()', () => {
            ...
            beforeEach(function () {
                ...
                const hierarchyBuf = createHierarchyBuffer([
                    { type: NODE_TYPE.LEAF, childrenBitField: 1, numPoints, byteOffset: dataOffset, byteSize: dataSize },
                    { type: NODE_TYPE.LEAF, childrenBitField: 0, numPoints: childNumPoints, byteOffset: dataOffset + dataSize, byteSize: dataSize },
                ]);
            ...
            it('assigns correct voxel keys in hierarchy', async () => {
                ...
                const hierarchy = [
                    { type: NODE_TYPE.NORMAL, childrenBitField: 0b00000001, numPoints: 100, byteOffset: 0,    byteSize: 1000 },
                    { type: NODE_TYPE.NORMAL, childrenBitField: 0b00010000, numPoints: 50,  byteOffset: 1000, byteSize: 500 },
                    { type: NODE_TYPE.LEAF,   childrenBitField: 0,          numPoints: 25,  byteOffset: 1500, byteSize: 250 },
                ];
            ...
            it('handles proxy nodes in the hierarchy', async () => {
                ...
                const hierarchy = [
                    { type: NODE_TYPE.NORMAL, childrenBitField: 0b00000100, numPoints: 200, byteOffset: 0,    byteSize: 2000 },
                    { type: NODE_TYPE.PROXY,  childrenBitField: 0b00000011, numPoints: 999, byteOffset: 5000, byteSize: 888 },
                ];
                const hierarchyBuf = createHierarchyBuffer(hierarchy);
            ...
            it('produces distinct keys for siblings', async () => {
                ...
                const hierarchy = [
                    { type: NODE_TYPE.NORMAL, childrenBitField: 0b00100000, numPoints: 100, byteOffset: 0,   byteSize: 100 },
                    { type: NODE_TYPE.NORMAL, childrenBitField: 0b10000001, numPoints: 80,  byteOffset: 100, byteSize: 80 },
                    { type: NODE_TYPE.LEAF,   childrenBitField: 0,          numPoints: 40,  byteOffset: 180, byteSize: 40 },
                    { type: NODE_TYPE.LEAF,   childrenBitField: 0,          numPoints: 30,  byteOffset: 220, byteSize: 30 },
                ];
                const hierarchyBuf = createHierarchyBuffer(hierarchy);
