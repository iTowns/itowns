...
class LASLoader {
    ...
    _parseView(view, options) {
        ...
        */
        ...
        quaternion.fromArray(options.out.rotation).invert(); // TODO: Verify why inverse quaternion ?
        box.makeEmpty();
        ...
        for (let i = 0; i < view.pointCount; i++) {
            ...
            LASAttributes.forEach((a) => { attributes[a][i] = getters[a](i); });
            getColor(i);
        }

        attributes.box = box.toJSON();
