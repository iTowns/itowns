 ...
 * Each of these nodes contains information about an image (origin, resoltion...
 * ) and an accessor to get the actual image data. This array is what
 * CogSource's parser later uses to create textures that contain the COG file
 * data.
 */
