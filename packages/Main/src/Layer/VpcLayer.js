                ...
                const promise =
                    this.source.sources[i].whenReady.then((src) => {
                        if (this.source.sources[i].isCopcSource) {
                            ...
                            this.source.spacings.push(src.info.spacing);

                            const root = new CopcNode(0, 0, 0, 0, pageOffset, pageLength, this.source, -1, i);
                            ...
                            this.source.spacings.push(spacing);

                            const root = new EntwinePointTileNode(0, 0, 0, 0, this.source, -1, i);
