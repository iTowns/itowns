                ...
                const promise =
                    this.source.sources[i].whenReady.then((src) => {
                        if (this.source.sources[i].isCopcSource) {
                            ...
                            this.spacings[i] = info.spacing;

                            secondaryRoot = new CopcNode(0, 0, 0, 0, pageOffset, pageLength, this, -1, i);
                            ...
                            this.spacings[i] = spacing;

                            secondaryRoot = new EntwinePointTileNode(0, 0, 0, 0, this, -1, i);
