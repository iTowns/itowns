...
describe('Extent', function () {
    ...
    it('should return true for overlapping extents', () => {
        ...
        assert.strictEqual(Extent.strictIntersectsExtent(a, b), true);
    });
    ...
    it('should return false for horizontally disjoint extents', () => {
        ...
        assert.strictEqual(Extent.strictIntersectsExtent(a, b), false);
    });
    ...
    it('should return false when one extent is completely to the left', () => {
        const a = new Extent('EPSG:4326', 10, 20, 0, 10);
        const b = new Extent('EPSG:4326', 0, 5, 0, 10);
